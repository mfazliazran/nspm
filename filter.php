...
// Compose pre-established rule
elseif (getParam('req') && Security::check(getParam('req', true), INT))
{
	$rule = new Rule();

	// Browse and register GET parameters
	foreach ($_GET as $k => $v)
	{
